                ...
                <div className="header-top-inner">
                    <div className="cnt-account">
                        <ul className="list-unstyled">
                            ...
                            <li><Link to="/blog"><i className="icon fa fa-check"></i>Checkout</Link></li>
                        </ul>
                    </div>
                        ...
                        <div className="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                            <div className="nav-outer">
                                <ul className="nav navbar-nav">
                                    <li className="active dropdown yamm-fw"> <a to="/!" data-hover="dropdown" className="dropdown-toggle" data-toggle="dropdown">Home</a> </li>
